...
func (rcv *Message) Opcode() Opcode {
...
func (rcv *Message) MutateOpcode(n Opcode) bool {
...
func MessageAddOpcode(builder *flatbuffers.Builder, opcode Opcode) {
	builder.PrependInt8Slot(0, int8(opcode), 0)
}
