...
export class AddUserResponse {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AddUserResponse {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAddUserResponse(bb:flatbuffers.ByteBuffer, obj?:AddUserResponse):AddUserResponse {
  return (obj || new AddUserResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAddUserResponse(bb:flatbuffers.ByteBuffer, obj?:AddUserResponse):AddUserResponse {
...
static startAddUserResponse(builder:flatbuffers.Builder) {
...
static endAddUserResponse(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createAddUserResponse(builder:flatbuffers.Builder, chatIdOffset:flatbuffers.Offset, userIdOffset:flatbuffers.Offset):flatbuffers.Offset {
