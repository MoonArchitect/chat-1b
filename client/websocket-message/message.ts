...
import { Payload, unionToPayload, unionListToPayload } from '../websocket-message/payload.js';
...
static createMessage(builder:flatbuffers.Builder, opcode:Opcode, payloadType:Payload, payloadOffset:flatbuffers.Offset):flatbuffers.Offset {
